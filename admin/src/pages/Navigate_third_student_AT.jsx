...
const Navigate_third_student_AT = () => {
  const { third, department } = useParams();
    ...
    <Container>
      ...
      <MainContent>
        ...
        <DashboardContainer className="sm:ml-[30px]">
          <Thirdyear_AT thirdyear={third} department={department} />
        </DashboardContainer>
        <Footer />
      </MainContent>
    </Container>
...
export default Navigate_third_student_AT;
