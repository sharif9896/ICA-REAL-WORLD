...
import Firstyear_AT from "../components/Firstyear_AT";
...
const Navigate_first_Students_AT = () => {
  const { first, department } = useParams();
    ...
    <Container>
      ...
      <MainContent>
        ...
        <DashboardContainer className="sm:ml-[30px]">
          <Firstyear_AT firstyear={first} department={department} />
        </DashboardContainer>
        <Footer />
      </MainContent>
    </Container>
...
export default Navigate_first_Students_AT;
