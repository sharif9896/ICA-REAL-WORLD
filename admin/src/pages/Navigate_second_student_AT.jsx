...
import Secondyear_AT from "../components/Secondyear_AT";
...
const Navigate_second_student_AT = () => {
  const { second, department } = useParams();
  ...
  return (
    <Container>
      ...
      <MainContent>
        <Header />
        <DashboardContainer className="sm:ml-[30px]">
          <Secondyear_AT Secondyear={second} department={department} />
        </DashboardContainer>
        <Footer />
      </MainContent>
    </Container>
...
export default Navigate_second_student_AT;
