...
const Secondyear_AT = ({ Secondyear, department }) => {
  //   console.log(Secondyear_AT, department);
  ...
  const finallist = classlist.filter((val) => {
    return val.Class === Secondyear && val.Department === department;
  });
