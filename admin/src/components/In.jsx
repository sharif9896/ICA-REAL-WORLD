  ...
  return (
    <>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-y-6 gap-x-6">
        ...
        <div className="card  flex justify-between items-center gap-2 text-amber-50 bg-[#921007] py-5 px-3 w-auto rounded">
          <h4>Total Absentees</h4>
          <p>10</p>
        </div>
        <div className="card  flex justify-between items-center gap-2 text-amber-50 bg-[#07920e] py-5 px-3 w-auto rounded">
